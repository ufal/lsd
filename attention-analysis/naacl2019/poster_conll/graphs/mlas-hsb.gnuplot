...
set xlabel "MLAS" offset 0,1,0 font "Helvetica Bold"
# output file name
set output "mlas-hsb.svg"
...
plot "mlas-hsb.tsv" using 0:3:2:xtic(1) with boxes lc variable, "" using 0:($3+2.5):4 with labels
