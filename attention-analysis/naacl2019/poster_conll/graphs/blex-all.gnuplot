...
set xlabel "BLEX" offset 0,1,0 font "Helvetica Bold"
# output file name
set output "blex-all.svg"
...
plot "blex-all.tsv" using 0:3:2:xtic(1) with boxes lc variable, "" using 0:($3+5):4 with labels
