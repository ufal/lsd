...
OUTPUT_DIR=/net/projects/LSD/attention_tomasz/lsd/attention-analysis/acl2020/graph-extraction/experiments
UAS_SCRIPT=/net/projects/LSD/attention_tomasz/lsd/attention-analysis/acl2020/scripts/attention_uas_multihead_max_heads.py
CONVCONLLU=/net/projects/LSD/attention_tomasz/lsd/attention-analysis/acl2020/graph-extraction/${LAN}dev.conllu
TESTDIR=/ha/home/limisiewicz/attention_my/lsd/attention-analysis/naacl2019/BertAA/BertAA-PUD-${LAN}/
TESTCONLLU=/net/projects/LSD/attention_tomasz/lsd/attention-analysis/acl2020/graph-extraction/${LAN}_pud-ud-test.conllu
