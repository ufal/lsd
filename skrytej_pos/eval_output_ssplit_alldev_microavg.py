...
for ssplit1 in range(0, 10, 2):
    ...
    logging.info(' '.join(['ssplit', str(ssplit1), 'seen', str(c1_seen), '/', str(t1_seen), '=', str(c1_seen/t1_seen) ]) )
    logging.info(' '.join(['ssplit', str(ssplit2), 'unsn', str(c2_unseen), '/', str(t2_unseen), '=', str(c2_unseen/t2_unseen) ]) )
    logging.info(' '.join(['ssplit', str(ssplit2), 'seen', str(c2_seen), '/', str(t2_seen), '=', str(c2_seen/t2_seen) ]) )
    logging.info(' '.join(['ssplit', str(ssplit2), 'unsn', str(c2_unseen), '/', str(t2_unseen), '=', str(c2_unseen/t2_unseen) ]) )


print('SEEN', correct_seen, '/', total_seen, '=', (correct_seen/total_seen) )
print('UNSEEN', correct_unseen, '/', total_unseen, '=', (correct_unseen/total_unseen) )
